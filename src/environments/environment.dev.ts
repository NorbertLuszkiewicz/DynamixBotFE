export const environment = {
  ...
  kickLoginRedirect: `https://id.kick.com/oauth/authorize?response_type=code&client_id=01K0VRXPBR7SFN7GR0ZYQMX709&scope=user:read channel:read channel:write chat:write events:subscribe moderation:ban&code_challenge_method=S256&code_challenge=`,
};
